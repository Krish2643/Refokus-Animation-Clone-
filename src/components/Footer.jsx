      ...
      <div className=" max-w-screen-xl mx-auto py-10 flex gap-32">
        ...
        <div className="basis-1/2 flex gap-4">
          <div className="basis-1/3">
            ...
            {["Portfolio", "twitter (x?)", "LinkedIn"].map((item, index) => (
              <a key={index} href="https://main--krish2643-portfolio.netlify.app/" className="block mt-2 capitalize text-zinc-600">{item}</a>
            ))}
          </div>
          <div className="basis-1/3">
            <h4 className=" mb-10 text-zinc-400 capitalize">socials</h4>
            {["Github", "twitter (x?)", "LinkedIn"].map((item, index) => (
              <a key={index} href="https://github.com/Krish2643" className="block mt-2 capitalize text-zinc-600">{item}</a>
            ))}
          </div>
